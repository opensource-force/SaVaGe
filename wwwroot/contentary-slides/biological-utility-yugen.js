(() => {
  ...
  container.style.cssText = 'width: 100%; height: 100vh; display: flex; justify-content: center; align-items: center; background: #0f2027; margin: 0; padding: 0; overflow: hidden;';
