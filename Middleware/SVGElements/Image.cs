...
public class Image
{
    ...
    public async Task<string> SVG(string wrapper, IWebHostEnvironment _env, string centerX, string centerY, string width, string height, string imageURL, string animations) 
    {
