(() => {
  ...
  container.style.cssText = 'width: 100%; height: 100vh; display: flex; justify-content: center; align-items: center; background: #0a0e27; margin: 0; padding: 0; overflow: hidden;';
